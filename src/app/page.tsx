...
// The V2 experience is the primary homepage: visiting the site root renders it
// directly. The dedicated /v2 route remains and is declared canonical, so the
// two URLs are not treated as duplicate content.
